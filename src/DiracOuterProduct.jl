...
# Abstract Types #
#----------------#
abstract DiracOuterProduct{P,K,B,T} <: AbstractDirac{P}

# Outer Product Types #
#---------------------#
immutable BasisOuterProduct{P,K,B,T} <: DiracOuterProduct{P,K,B,T}
...
immutable OuterProductSum{P,K,B,T} <: DiracOuterProduct{P,K,B,T}
